...
const rows = [
  ...
  ['Vitamin C', 'Ascorbic Acid', 'Dietary Supplement', 'C6H8O6', 'Industrial Chemicals'],
  ['Vitamin E (Dry Powder and Liquid)', 'Tocopherol', 'Cosmetics, Dietary Supplement', 'C29H50O2', 'Industrial Chemicals'],
  ['Vitamin E (BASF)', 'Tocopherol', 'Cosmetics, Dietary Supplement', 'C29H50O2', 'Industrial Chemicals'],
  ['Vitamin A (Dry Powder)', 'Retinol', 'Dietary Supplement', 'C20H30O', 'Industrial Chemicals'],
  ['Vitamin D3 (Feed Grade/Pharma Grade)', 'Cholecalciferol', 'Dietary Supplement', 'C27H44O', 'Industrial Chemicals'],
  ['Vitamin B1 (Mono and Hydro)', 'Thiamine', 'Dietary Supplement', 'Varies by salt form', 'Industrial Chemicals'],
  ['Vitamin B2 (Feed and Pharma)', 'Riboflavin', 'Dietary Supplement', 'C17H20N4O6', 'Industrial Chemicals'],
  ['Vitamin B6', 'Pyridoxine', 'Dietary Supplement', 'C8H11NO3', 'Industrial Chemicals'],
  ['Vitamin B5 (Inositol)', 'Pantothenic Acid / Inositol Grade', 'Dietary Supplement', 'Varies by grade', 'Industrial Chemicals'],
  ['Vitamin K3', 'Menadione', 'Dietary Supplement, Animal Feed', 'C11H8O2', 'Industrial Chemicals'],
  ['Vitamin AD3', 'Vitamin A and Vitamin D3 Blend', 'Dietary Supplement, Animal Feed', 'Mixture', 'Industrial Chemicals'],
  ['Niacin', 'Nicotinic Acid', 'Dietary Supplement', 'C6H5NO2', 'Industrial Chemicals'],
  ['Folic Acid', 'Folic Acid', 'Dietary Supplement', 'C19H19N7O6', 'Industrial Chemicals'],
  ['Biotin (Feed and Pharma)', 'Biotin', 'Dietary Supplement', 'C10H16N2O3S', 'Industrial Chemicals'],
  ['Vitamin A Palmitate (1.6/1.7)', 'Retinyl Palmitate', 'Dietary Supplement, Food Fortification', 'C36H60O2', 'Industrial Chemicals'],
  ...
  ['D-Calcium Pantothenate', 'Calcium Pantothenate', 'Dietary Supplement, Animal Feed', 'C18H32CaN2O10', 'Industrial Chemicals'],
